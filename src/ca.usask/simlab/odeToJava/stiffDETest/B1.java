...
/**
 * Stiff DE test set problem B1, linear with non-real eigenvalues.
 * <p>
 * Eigenvalues of -1+-10i, -100+-100i.
 * <p>
 ...
 */     
public class B1 extends RHS {
    @Override
    public Float64Vector f(Float64 t, Float64Vector y) {
        return Float64Vector.valueOf(
            -y.getValue(0) + y.getValue(1),
            -100 * y.getValue(0) - y.getValue(1),
            -100 * y.getValue(2) + y.getValue(3),
            -10000 * y.getValue(2) - 100 * y.getValue(3));
    }
