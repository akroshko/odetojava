...
/**
 * Stiff DE test set problem C2, non-linear coupling from smooth components
...
public class C2 extends RHS {
    ...
    public Float64Vector f(Float64 t, Float64Vector y) {
        ...
        return Float64Vector.valueOf(
            -y.getValue(0) + 2.0,
            -10.0*y.getValue(1) + this.beta*y.getValue(0)*y.getValue(0),
            -40.0*y.getValue(2) + 4.0*this.beta*(y.getValue(0)*y.getValue(0) + y.getValue(1)*y.getValue(1)),
            -100.0*y.getValue(3) + 10.0*this.beta*(y.getValue(0)*y.getValue(0) + y.getValue(1)*y.getValue(1) + y.getValue(2)*y.getValue(2)));
    }
