...
/**
 * Stiff DE test set problem D5, non-linear with real eigenvalues from reactor
 * kinetics.
 * <p>
 ...
 */                  
public class D5 extends RHS {
    @Override
    public Float64Vector f(Float64 t, Float64Vector y) {
        return Float64Vector.valueOf(
            0.01 - (1 + (y.getValue(0) + 1000)*(y.getValue(0) + 1))*(0.01 + y.getValue(0) + y.getValue(1)),
            0.01 - (1 + y.getValue(1)*y.getValue(1))*(0.01 + y.getValue(0) + y.getValue(1)));
    }
