...
/**
 * Stiff DE test set problem F5, a chemical kinetics problem.
 * <p>
...
public class F5 extends RHS {
    ...
    public Float64Vector f(Float64 t, Float64Vector y) {
        return Float64Vector.valueOf(
            -3e11*y.getValue(0)*y.getValue(1) + 1.2e8*y.getValue(3) - 9e11*y.getValue(0)*y.getValue(2),
            -3e11*y.getValue(0)*y.getValue(1) + 2e7*y.getValue(3),
            -9e11*y.getValue(0)*y.getValue(2) + 1e8*y.getValue(3),
            3e11*y.getValue(0)*y.getValue(1) - 1.2e8*y.getValue(3) + 9e11*y.getValue(0)*y.getValue(2)); 
    }
