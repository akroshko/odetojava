...
/**
 * Stiff DE test set problem C1, non-linear coupling from transient components
 * to smooth components.
 * <p>
 ...
 */         
public class C1 extends RHS {
    @Override
    public Float64Vector f(Float64 t, Float64Vector y) {
        return Float64Vector.valueOf(
            -y.getValue(0) + y.getValue(1) * y.getValue(1) + y.getValue(2) * y.getValue(2) * y.getValue(2) + y.getValue(3) * y.getValue(3),
            -10 * y.getValue(1) + 10 * (y.getValue(2) * y.getValue(2) + y.getValue(3) * y.getValue(3)),
            -40 * y.getValue(2) + 40 * y.getValue(3) * y.getValue(3),
            -100 * y.getValue(3) + 2);
    }
