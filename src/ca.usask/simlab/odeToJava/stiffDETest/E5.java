...
/**
 * Stiff DE test set problem E5, non-linear with non-real eigenvalues, chemical
 * pyrolysis.
 * <p>
 ...
 */                        
public class E5 extends RHS {
    @Override
    public Float64Vector f(Float64 t, Float64Vector y) {
        return Float64Vector.valueOf(
            -7.89e-10*y.getValue(0) - 1.1e7*y.getValue(0)*y.getValue(2),
            7.89e-10*y.getValue(0) - 1.13e9*y.getValue(1)*y.getValue(2),
            7.89e-10*y.getValue(0) - 1.1e7*y.getValue(0)*y.getValue(2) + 1.13e3*y.getValue(3) - 1.13e9*y.getValue(1)*y.getValue(2),
            1.1e7*y.getValue(0)*y.getValue(2) - 1.13e3*y.getValue(3));
    }
