...
/**
 * Stiff DE test set problem F2, a chemical kinetics problem.
 * <p>
 ...
 * 1-27, 1987.
 */ 
public class F2 extends RHS {
    @Override
    public Float64Vector f(Float64 t, Float64Vector y) {
        return Float64Vector.valueOf(
            -y.getValue(0) - y.getValue(0) * y.getValue(1) + 294 * y.getValue(1),
            y.getValue(0) * (1 - y.getValue(1)) / 98 - 3 * y.getValue(1));
    }
