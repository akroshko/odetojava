...
/**
 * Stiff DE test set problem D2, non-linear with real eigenvalues from chemistry.
 * <p>
 ...
 */               
public class D2 extends RHS {
    @Override
    public Float64Vector f(Float64 t, Float64Vector y) {
        return Float64Vector.valueOf(
            -0.04*y.getValue(0) + 0.01*y.getValue(1)*y.getValue(2),
            400*y.getValue(0) - 100*y.getValue(1)*y.getValue(2) - 3000*y.getValue(1)*y.getValue(1),
            30*y.getValue(1)*y.getValue(1));
    }
