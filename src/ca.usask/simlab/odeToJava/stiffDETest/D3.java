...
/**
 * Stiff DE test set problem D3, non-linear with real eigenvalues from chemistry.
 * <p>
 ...
 */                
public class D3 extends RHS {
    @Override
    public Float64Vector f(Float64 t, Float64Vector y) {
        return Float64Vector.valueOf(
            y.getValue(2) - 100 * y.getValue(0) * y.getValue(1),
            y.getValue(2) + 2 * y.getValue(3) - 100 * y.getValue(0) * y.getValue(1) - 20000 * y.getValue(1) * y.getValue(1),
            -y.getValue(2) + 100 * y.getValue(0) * y.getValue(1),
            -y.getValue(3) + 10000 * y.getValue(1) * y.getValue(1));
    }
