 ...
 */     
public class A3 extends RHS {
    @Override
    public Float64Vector f(Float64 t, Float64Vector y) {
        return Float64Vector.valueOf(
            -10000 * y.getValue(0) + 100 * y.getValue(1) - 10 * y.getValue(2) + y.getValue(3),
            -1000 * y.getValue(1) + 10 * y.getValue(2) - 10 * y.getValue(3),
            -y.getValue(2) + 10 * y.getValue(3),
            -.1 * y.getValue(3));
    }
