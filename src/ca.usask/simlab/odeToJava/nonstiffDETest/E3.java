...
/**
 * Nonstiff DE test set problem E3, derived from Duffing's equation.
 * <p>
...
public class E3 extends RHS {
    ...
    public Float64Vector f(Float64 t, Float64Vector y) {
        return Float64Vector.valueOf(
            y.getValue(1),
            Math.pow(y.getValue(0), 3) / 6 - y.getValue(0) + 2 * Math.sin(2.78535 * t.doubleValue()));
    }
