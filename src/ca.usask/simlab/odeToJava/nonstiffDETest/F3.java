...
/**
 * F3, problems with discontinuities.
 * <p>
...
public class F3 extends RHS {
    ...
    public Float64Vector f(Float64 t, Float64Vector y) {
        return Float64Vector.valueOf(
            y.getValue(1),
            0.01 * y.getValue(1) * (1 - y.getValue(0) * y.getValue(0)) - y.getValue(0) - Math.abs(Math.sin(Math.PI * t.doubleValue())));
    }
