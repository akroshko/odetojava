...
/**
 * Nonstiff DE test set problem A5, a spiral curve.
 * <p>
 ...
 */        
public class A5 extends RHS {
    @Override
    public Float64Vector f(Float64 t, Float64Vector y) {
        return Float64Vector.valueOf((y.getValue(0) - t.doubleValue()) / (y.getValue(0) + t.doubleValue()));
    }
