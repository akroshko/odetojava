...
/**
 * Nonstiff DE test set problem C1, a radioactive decay chain.
 * <p>
...
public class C1 extends RHS {
    ...
    public Float64Vector f(Float64 t, Float64Vector y) {
        ...
        return Float64Vector.valueOf(
            -1 * y.getValue(0),
            y.getValue(0) - y.getValue(1),
            y.getValue(1) - y.getValue(2),
            y.getValue(2) - y.getValue(3),
            y.getValue(3) - y.getValue(4),
            y.getValue(4) - y.getValue(5),
            y.getValue(5) - y.getValue(6),
            y.getValue(6) - y.getValue(7),
            y.getValue(7) - y.getValue(8),
            y.getValue(8));
    }
