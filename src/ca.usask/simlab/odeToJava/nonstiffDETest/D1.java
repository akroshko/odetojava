...
/**
 * Nonstiff DE test set problem D1, orbit equations with eccentricity of 0.1.
 * <p>
...
public class D1 extends RHS {
    ...
    public Float64Vector f(Float64 t, Float64Vector y) {
        return Float64Vector.valueOf(
            y.getValue(2),
            y.getValue(3),
            -y.getValue(0) / Math.pow((y.getValue(0) * y.getValue(0) + y.getValue(1) * y.getValue(1)), 1.5),
            -y.getValue(1) / Math.pow((y.getValue(0) * y.getValue(0) + y.getValue(1) * y.getValue(1)), 1.5));
    }
