...
/**
 * Nonstiff DE test set problem B1, the growth of two conflicting populations.
 * <p>
...
public class B1 extends RHS {
    ...
    public Float64Vector f(Float64 t, Float64Vector y) {
        return Float64Vector.valueOf(2 * (y.getValue(0) - y.getValue(0) * y.getValue(1)),
                                     -1 * (y.getValue(1) - y.getValue(0) * y.getValue(1)));
    }
